                      ...
                      <tbody>
                        ...
                        if(!empty($data["list"])) {
                          foreach($data["list"] as $list) {
                            ...
                            . "<td>".$list["werks"]."</td>"
                            . "<td>".$list["name1"]."</td>"
                            . "<td class='text-center'><a href='?action=$action&id=".$list["werks"]."' class='btn btn-outline-secondary btn-xs'><i class='material-icons'>edit</i></a></td>"
                            . "<td class='text-center'><a href='?action=$action&id=".$list["werks"]."&delete=true' class='btn btn-outline-danger btn-xs'><i class='material-icons'>delete</i></a></td>"
                            . "</tr>";
                          }
                        }
                        ?>
        ...
        <form method="POST" action="?action=<?php echo $action; ?>&upload=excel" enctype="multipart/form-data">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <a href="media/template/template_plant.xlsx">Download Template</a>
