              ...
              foreach ($_SESSION["USERMENU"] as $menu) {
                if($menu["groupid"] == $grp["groupid"]) {
                  if ($action == strtolower($menu["menuid"])) {
                    echo '<a href="?action=' . $menu["menuid"] . '" class="list-group-item list-group-item-action active"><span class="">' . $menu["name1"] . '</span></a>';
                  } else {
                    echo '<a href="?action=' . $menu["menuid"] . '" class="list-group-item list-group-item-action"><span class="">' . $menu["name1"] . '</span></a>';
                  }
                }
              }
              echo '</div>';
