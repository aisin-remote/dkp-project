  ...
  <body>		
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-sm-12">
                        <div class="d-flex justify-content-end">
                          <!-- button placement -->
                          <button type="button" id="btn_scn2" name="btn_scn1" class="btn btn-info mr-2" data-toggle="modal" data-target="#modal_02"><span class="material-icons">qr_code_scanner</span> Scan Kanban Delivery</button>
              ...
              <div class="col-12">
                <div class="card mt-1">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      <label class="col-form-label col-lg-2 col-md-3 col-sm-12">SO/DO. Number</label>
                      <div class="col-lg-4 col-md-6 col-sm-12">
                        <input type="text" name="vbeln" id="vbeln" class="form-control" maxlength="20" value="" >
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-4 col-md-6 col-sm-12">
                        <input type="text" name="lifnr" id="lifnr" class="form-control" maxlength="20" value="" >
                      </div>
                    </div>
                    <table class="table">
                      <thead>
    ...
    <div class="modal fade" id="modal_02" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="modal_02_label" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modal_02_label">Scan Kanban Delivery</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <div class="form-group">
              <label class="col-form-label">QR Code Kanban Delivery</label>
    ...
    <script>
      ...
      function validateQrCodeKanbanRecv(qrcode) {
        var arr_code = qrcode.split(/\s+/);
        var matnr = arr_code[3].replace(/\b0+/g, '');
        var lifnr = arr_code[4];
        $("#lifnr").val(lifnr);
        var menge = parseInt(arr_code[9]);
