                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-3 col-md-5 col-sm-12">
                        <select name="werks" class="form-control">
                          <?php 
                          if(!empty($data["plants"])) {
                            foreach($data["plants"] as $grp) {
                              if($grp["werks"] == $data["data"]["werks"]) {
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-3 col-md-5 col-sm-12">
                        <input type="text" name="lgort" class="form-control" maxlength="5" value="<?php echo $data["data"]["lgort"]; ?>" <?php if(!empty($data["data"]["lgort"])) {echo "readonly";} ?>>
                      </div>
                    </div>
                    
                    <div class="form-group row">
                      <label class="col-form-label col-lg-2 col-md-3 col-sm-12">S.Loc. Description</label>
