                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-sm-12">
                        <div class="d-flex justify-content-end">
                          <!-- button placement -->
                          <button type="submit" id="btn_save" name="btn_save" value="btn_save" class="btn btn-primary"><span class="material-icons">send</span> Reverse</button>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-3 col-md-6 col-sm-12">
                        <input type="text" name="mblnr" maxlength="20" class="form-control" value="<?=$data["mkpf"]["mblnr"]?>" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-2 col-md-6 col-sm-12">
                        <input type="text" name="mjahr" maxlength="4" class="form-control" value="<?=$data["mkpf"]["mjahr"]?>" readonly>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-2 col-md-6 col-sm-12">
                        <input type="date" name="budat" maxlength="4" class="form-control" value="<?=$data["mkpf"]["budat"]?>" readonly>
                      </div>
                    </div>
                    <table class="table">
                      <thead>
                        <tr>
                          ...
                          <th class="text-nowrap text-right">Quantity</th>
