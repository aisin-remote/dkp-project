...
<body>
                        ...
                        if (!empty($data["list"])) {
                          foreach ($data["list"] as $list) {
                            ...
                            echo "<tr>"
                              ...
                              . "<td class='text-center text-nowrap'>" . $list["ebeln"] . "</td>"
                              . "<td class='text-center text-nowrap'>" . $list["aufnr"] . "</td>"
                              . "</tr>";
                          }
                        }
                        ?>
          ...
          <div class="modal-body">
            <div class="container-fluid">
              <div class="form-group row">
                <label class="col-form-label col-lg-2 col-md-6 col-sm-12">Posting Date</label>
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <input type="date" name="budat_from" class="form-control" value="<?= $budat_from ?>">
                </div>
                <label class="col-form-label col-lg-2 col-md-6 col-sm-12">To</label>
                <div class="col-lg-4 col-md-6 col-sm-12">
                  <input type="date" name="budat_to" class="form-control" value="<?= $budat_to ?>">
                </div>
              </div>
              <div class="form-group row">
              ...
              <div class="form-group row">
                <label class="col-form-label col-lg-2 col-md-3 col-sm-12">Type Material</label>
                <div class="col-lg-10 col-md-9 col-sm-12">
  ...
  <script>
    ...
    $("#type").change(function () {
      $.ajax({
        type: "GET",
        url: "?action=api_get_material",
        data: {
          type: $("#type").val()
        },
        dataType: "JSON",
        success: function (response) {
          $("#matnr").html("<option value=''>Please Select Material</option>");
          $.each(response, function (i, field) {
            $("#matnr").append("<option value='" + field.matnr + "'>" + field.matnr + " - " + field.name1 + " " + field.backno + "</option>");
          });
        }
      })
    })
