                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-3 col-md-5 col-sm-12">
                        <input type="text" name="werks" class="form-control" maxlength="5" value="<?php echo $data["data"]["werks"]; ?>" <?php if(!empty($data["data"]["werks"])) {echo "readonly";} ?>>
                      </div>
                    </div>
                    
                    <div class="form-group row">
                      <label class="col-form-label col-lg-2 col-md-3 col-sm-12">Plant Description</label>
