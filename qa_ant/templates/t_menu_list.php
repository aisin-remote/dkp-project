                      ...
                      <tbody>
                        ...
                        if(!empty($data["list"])) {
                          foreach($data["list"] as $list) {
                            echo "<tr>"
                            . "<td><a href='?action=$action&id=".$list["menuid"]."'><u>".$list["menuid"]."</u></a></td>"
                            . "<td>".$list["name1"]."</td>"
                            . "<td class='text-center'>".$list["sort1"]."</td>";
                            if($list["groupid"] == "SET") {
                              echo "<td>&nbsp;</td>";
                            } else {
                              echo "<td class='text-center'><a href='?action=$action&id=".$list["menuid"]."&delete=true' class='btn btn-danger btn-xs'><i class='material-icons'>delete</i></a></td>";
                            }
