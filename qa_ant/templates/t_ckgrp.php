                      ...
                      <tbody>
                        ...
                        if(!empty($data["list"])) {
                          foreach($data["list"] as $list) {
                            echo "<tr>"
                            . "<td><a href=\"javascript:openModalEdit('".$list["grp_id"]."','".$list["grp_no"]."','".$list["name1"]."')\">".$list["grp_id"]."</a></td>"
                            . "<td>".$list["grp_no"]."</td>"
                            . "<td>".$list["name1"]."</td>"
                            . "<td class='text-center'><a href='?action=$action&id=".$list["grp_id"]."&delete=true' class='btn btn-danger btn-xs'><i class='material-icons'>delete</i></a></td>"
                            . "</tr>";
                          }
                        }
                        ?>
