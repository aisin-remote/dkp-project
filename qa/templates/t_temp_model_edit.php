                                ...
                                <div class="card mt-1">
                                    <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-7 col-md-6 col-sm-12">
                                                        <input type="text" name="partno"
                                                            ...
                                                            value="<?= $header[0]["partno"] ?>" required />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-6"></div>
                                            <input type="hidden" name="excel1" value="<?= $header[0]["tmpfl"] ?>">
                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <th colspan="4" class="text-right">
                                                        <button type="button" class="btn btn-info"
                                                            id="btn_add_grup"><span class="material-icons">add</span>
                                                            Add
                                                            Group</button>
                                                    </th>
                                                </tr>
                                            ...
                                            <tbody class="">
                                                ...
                                                if (!empty($grup)) {
                                                    ...
                                                    foreach ($grup as $g) {
                                                        ...
                                                        <tr id="table_<?= $i ?>">
                                                            ...
                                                            <td class="text-left w-50">
                                                                <div class="row">
                                                                    <label
                                                                        class="col-form-label font-weight-normal col-lg-2 col-md-3 col-sm-12 pr-0">File
                                                                        Gambar</label>
                                                                    <div class="input-group col-lg-5 col-md-6 col-sm-12 pl-0">
                                                                        <div class="custom-file">
                                                                            <input type="file" class="custom-file-input"
                                                                                id="image_1" name="image[]"
                                                                                accept=".jpg, .jpeg, .png">
                                                                            <label class="custom-file-label" id="image_label_1"
                                                            ...
                                                            <td class="text-right" id="button-1">
                                                                <div class="row">
                                                                    <a class="btn btn-sm btn-primary mr-1"
                                                                        href="?action=<?= $action ?>&id=<?= $id ?>&grup=<?= $g["grupid"] ?>"><span
                                                                            class='material-icons'>visibility</span></a>
                                                                    <button id='btn_del_grup_<?= $i ?>' type='button'
                                                                        class='btn btn-sm btn-danger btn_del_grup'><span
                                                    ...
                                                    <tr id="table_1">
                                                        ...
                                                        <td class="text-left w-50">
                                                            <div class="row">
                                                                <label
                                                                    class="col-form-label font-weight-normal col-lg-2 col-md-3 col-sm-12 pr-0">File
                                                                    Gambar</label>
                                                                <div class="input-group col-lg-6 col-md-6 col-sm-12 pl-0">
                                                                    <div class="custom-file">
                                                                        <input type="file" class="custom-file-input"
                                                                            id="image_1" name="image[]"
                                                                            accept=".jpg, .jpeg, .png">
                                                        ...
                                                        <td class="text-right" id="button-1">
                                                            <div class="row">
                                                                <a class="btn btn-sm btn-primary mr-1 <?= ($cntGrup[0]["cnt"] == 0) ? 'disabled' : '' ?>"
                                                                    href="?action=<?= $action ?>&id=<?= $id ?>&grup=<?= $g["grupid"] ?>"><span
                                                                        class='material-icons'>visibility</span></a>
                                                                <button id='btn_del_grup_1' type='button'
                                                                    class='btn btn-sm btn-danger btn_del_grup'><span
                                                                        class='material-icons'>delete</span></button>
                                                            </div>
                                                        </td>
                                        ...
                                        if (!empty($grup)) {
                                            ...
                                            foreach ($grup as $g) {
                                                ?>
                                                <table class="table table-md mb-4" id="table_1">
                                                    <thead class="my-2">
                                                        <tr>
                                                            <th class="text-left">
                                                                <div class="row">
                                                            ...
                                                            <th class="text-right" id="button-1">
                                                                <div class="row">
                                                                    <a class="btn btn-primary mr-1"
                                                                        href="?action=<?= $action ?>&id=<?= $id ?>&grup=<?= $g["grupid"] ?>"><span
                                                                            class='material-icons'>visibility</span></a>
                                                                    <button id='btn_del_grup_1' type='button'
                                                                        class='btn btn-danger btn_del_grup'><span
                                                                            class='material-icons'>delete</span></button>
                                                                </div>
                                                            </th>
                                                        </tr>
                                            ...
                                            <table class="table table-md mb-4" id="table_1">
                                                <thead class="my-2">
                                                    <tr>
                                                        ...
                                                        <th class="text-right" id="button-1">
                                                            <div class="row">
                                                                <a class="btn btn-primary mr-1 <?= ($cntGrup[0]["cnt"] == 0) ? 'disabled' : '' ?>"
                                                                    href="?action=<?= $action ?>&id=<?= $id ?>&grup=<?= $g["grupid"] ?>"><span
                                                                        class='material-icons'>visibility</span></a>
                                                                <button id='btn_del_grup_1' type='button'
                                                                    class='btn btn-danger btn_del_grup'><span
