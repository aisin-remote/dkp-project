...
class User
{
  ...
  public function insert($data = array())
  {
    ...
    if (empty($data)) {
      ...
      $conn = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD);
      $sql = "INSERT INTO m_user (usrid,usrpw,name1,phone,stats,crt_by,crt_dt,lifnr, ttd) "
        . "values (:usrid,:usrpw,:name1,:phone,'A',:crt_by,CURRENT_TIMESTAMP,:lifnr,:ttd)";
      $stmt = $conn->prepare($sql);
      ...
      $stmt->bindValue(":ttd", $data["foto_ktp"], PDO::PARAM_STR);
