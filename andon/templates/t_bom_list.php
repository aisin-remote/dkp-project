                                            ...
                                            <tbody>
                                                ...
                                                if (!empty($bomlist)) {
                                                    foreach ($bomlist as $list) {
                                                        echo "<tr>"
                                                            . "<td class=''>" . $list["matnr"] . "</td>"
                                                            . "<td class=''>" . $list["name1"] . "</td>"
                                                            . "<td class=''>" . $list["menge"] . "</td>"
                                                            . "<td class=''>" . $list["meins"] . "</td>"
                                                            . "<td class='text-center'>"
                                                            . "<a href='?action=$action&id=" . $list["matnr"] . "' class='btn btn-outline-dark btn-xs'><i class='material-icons'>edit</i> Edit</a>"
                                                            . "</td>"
                                                            . "</tr>";
                                                    }
                                                }
      ...
      <form method="POST" action="?action=<?php echo $action; ?>&upload=excel" enctype="multipart/form-data">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modal_upload_label"><span class="material-icons">upload_file</span> Upload Data BOM</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <a href="media/template/template-bom.xls">Download Template</a>
