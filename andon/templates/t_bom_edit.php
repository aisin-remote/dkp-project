                                ...
                                <div class="card mt-1">
                                   ...
                                   <!-- <option value=''>Please Select Sub Material</option> -->
                                                            ...
                                                            foreach ($matlist as $row) {
                                                                ?>
                                                                <option value="<?php echo $row["matnr"]; ?>" <?php if ($row["matnr"] == $bomheader["matnr"]) {
                                                                       echo "selected";
                                                                   } else {
                                                                       echo "";
                                            ...
                                            <div class="col-6">
                                                <button type="submit" id="btn_save" name="btn_save" value="btn_save"
                                                    class="btn btn-primary float-right"><span class="material-icons">send</span>
                                                    Post</button>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            if (!empty($bomdetail)) {
                                                ...
                                                foreach ($bomdetail as $data) {
                                                    echo "<tbody id='mseg'>
                                                          <tr id='mseg_data_" . $i . "'>
                                                          <td>
                                                          <select name='matn1[]' class='form-control form-control-sm select2' required='required'>
                                                          <option value=''>Please Select Sub Material</option>";
                                                    ...
                                                    echo "</select>
                                                           ...
                                                           <button id='btn_del_item_1' type='button' onclick='deleteItem(\"" . $i . "\")' class='btn btn-danger btn-sm btn_del_item'><span class='material-icons'>delete</span></button>
                                                           </td>
                                                           </tr>
                                                           </tbody>";
                                                    $i++;
