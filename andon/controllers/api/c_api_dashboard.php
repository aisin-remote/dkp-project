...
if ($action == "api_dashboard_adn") {
  ...
  $query = "select a.line_id, b.name1 as line_name, CONCAT(c.name1) as dies_name, a.cctime, a.pln_qty, a.prd_time, coalesce(a.prd_qty,0) as prd_qty, 
            ...
            where a.prd_dt = '$today' and TO_CHAR(TO_TIMESTAMP(a.prd_dt||' '||a.time_start,'YYYY-MM-DD HH24:MI'),'HH24') = '$jam_now' AND a.stats = 'A' ";
  //$query .= "and a.stats = 'A' ";
