...
<body>
  ...
  <!-- Modal -->
  <form method="post" action="?action=<?= $action ?>&id=<?= $id ?>&" class="modal fade" id="mymodal01" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="mymodal01Label" aria-hidden="true">
