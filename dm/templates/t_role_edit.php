                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-3 col-md-5 col-sm-12">
                        <input type="text" name="roleid" class="form-control" maxlength="100" value="<?php echo $data["data"]["roleid"]; ?>" <?php if (!empty($data["data"]["roleid"])) {
                                                                                                                                                echo "readonly";
                                                                                                                                              } ?>>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-4 col-md-9 col-sm-12">
                        <select name="menus[]" class="form-control select2" multiple="">
                          ...
                          ?>
                            <option value="<?php echo $val["menuid"]; ?>" <?php
                                                                          ...
                                                                          ?>><?php echo $val["menu_group"] . " - " . $val["name1"]; ?></option>
                          <?php
                          }
                          ?>
                        </select>
