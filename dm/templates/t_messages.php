                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-lg-6 col-sm-12">
                      <!-- filter placement -->
                      <form method="get" target="?action=<?= $action ?>">
                    ...
                    <div class="col-lg-6 col-sm-12">
                      <div class="d-flex justify-content-end">
                        <!-- button placement -->
                        <a class="btn btn-dark-blue btn-sm mx-2" href="?action=<?= $action ?>&id=0">New Subject</a>
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        if (!empty($data["list"])) {
                          foreach ($data["list"] as $list) {
                            echo "<tr>"
                              ...
                              . "<a href='?action=$action&id=" . $list["msg_id"] . "' class='btn btn-outline-dark btn-xs text-center mb-1'><i class='material-icons'>visibility</i> detail</a>"
                              . "</td>"
                              . "</tr>";
                          }
                        }
