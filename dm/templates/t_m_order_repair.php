                          ...
                          if (!empty($data["list"])) {
                            foreach ($data["list"] as $row) {
                              ...
                              <tr>
                                ...
                                <td>
                                  <?php echo $row["ori_date"]; ?>
                                </td>
                                <td>
                                  <?php echo $row["ori_type"]; ?>
                                </td>
                                <td>
                                  <?php echo $row["stats"]; ?>
                                </td>
                                <td class="text-center"><a class="btn btn-xs btn-outline-dark"
                                    href="?action=<?php echo $action ?>&id=<?php echo $row["ori_id"]; ?>"><i
