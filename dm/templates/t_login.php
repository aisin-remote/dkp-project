...
<link href="vendors/ega/css/login.css?time=<?php echo date("Ymdhis"); ?>" rel="stylesheet" type="text/css" />
      ...
      <div class="card-body">
        <div class="container">
          <form action="?action=<?=$action?>" method="POST">
            ...
            <button class="mt-3 btn btn btn-dark-blue px-5" type="submit" name="signin">Log In</button>
            <?php
            if (isset($_GET["error"])) {
