  ...
  if (isset($_GET["id"])) {
    ...
    if ($step == "1") {
      if (isset($_POST["save"])) {
        ...
        $diesid_list = $dies->getListDies(null, $model_list[0]["model_id"]);
        ...
        if (isset($_GET["model_id"])) {
          ...
          $diesid_list = $dies->getListDies(null, $model_id);
        }
        $dies_id = null;
      ...
      if (isset($_POST["save"])) {
        ...
        if (!empty($photo["tmp_name"])) {
          ...
          if ($photo["type"] == "image/jpeg" || $photo["type"] == "image/jpg" || $photo["type"] == "image/png") {
            ...
            $message = "Gambar [1.1.1	Chemical Cleaning] harus dalam format JPEG atau PNG";
