                                                ...
                                                <tbody>
                                                    ...
                                                    if (!empty($list)) {
                                                        foreach ($list as $row) {
                                                            echo
                                                            "<tr>"
                                                                . "<td class='text-center pr-4'>" . $row["ldseq"] . "</td>"
                                                                . "<td class=''>" . $row["ldnum"] . "</td>"
                                                                . "<td class=''>" . $row["matnr"] . "</td>"
                                                                . "<td class=''>" . $row["matn1"] . "</td>"
                                                                // . "<td class='text-center'>" . $row["kanban_i"] . "</td>"
                                                                // . "<td class='text-center'>" . $row["kanban_e"] . "</td>"
