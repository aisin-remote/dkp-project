                ...
                <div class="card mt-2">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      <label class="col-form-label col-lg-2 col-md-3 col-sm-12">Customer No.</label>
                      <div class="col-lg-3 col-md-5 col-sm-12">
                        <input type="text" name="lifnr" class="form-control" maxlength="40" value="<?php echo $data["data"]["lifnr"]; ?>" <?php if(!empty($data["data"]["matnr"])) {echo "readonly";} else {echo "required";} ?>>
                      </div>
                    </div>
                    
                    <div class="form-group row">
                      <label class="col-form-label col-lg-2 col-md-3 col-sm-12">Customer Name</label>
                      <div class="col-lg-3 col-md-5 col-sm-12">
