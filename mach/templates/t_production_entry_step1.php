                    ...
                    <div class="row">
                      <div class="col-6">
                        <div class="form-group row">
                          <label class="col-form-label col-lg-4 col-md-3 col-sm-12">Shift</label>
                        ...
                        <div class="form-group row">
                          <label class="col-form-label col-lg-4 col-md-3 col-sm-12">Date</label>
                          <div class="col-lg-8 col-md-5 col-sm-12">
                        ...
                        <div class="form-group row">
                          <label class="col-form-label col-lg-4 col-md-3 col-sm-12">Leader</label>
                          <div class="col-lg-8 col-md-5 col-sm-12">
                        ...
                        <div class="form-group row">
                          <label class="col-form-label col-lg-4 col-md-3 col-sm-12">JP</label>
                          <div class="col-lg-8 col-md-5 col-sm-12">
                        ...
                        <div class="form-group row">
                          <label class="col-form-label col-lg-4 col-md-3 col-sm-12">Operator 1</label>
                          <div class="col-lg-8 col-md-5 col-sm-12">
                        ...
                        <div class="form-group row">
                          <label class="col-form-label col-lg-4 col-md-3 col-sm-12">Operator 2</label>
                          <div class="col-lg-8 col-md-5 col-sm-12">
                        ...
                        <div class="form-group row">
                          <label class="col-form-label col-lg-4 col-md-3 col-sm-12">Operator 3</label>
                          <div class="col-lg-8 col-md-5 col-sm-12">
                        ...
                        <div class="form-group row">
                          <label class="col-form-label col-lg-4 col-md-3 col-sm-12">Operator 4</label>
                          <div class="col-lg-8 col-md-5 col-sm-12">
                      ...
                      <div class="col-6">
                        <div class="form-group row">
                          <label class="col-form-label col-lg-4 col-md-3 col-sm-12">Operator 5</label>
                          <div class="col-lg-8 col-md-5 col-sm-12">
                        ...
                        <div class="form-group row">
                          <label class="col-form-label col-lg-4 col-md-3 col-sm-12">Operator 6</label>
                          <div class="col-lg-8 col-md-5 col-sm-12">
                        ...
                        <div class="form-group row">
                          <label class="col-form-label col-lg-4 col-md-3 col-sm-12">Operator 7</label>
                          <div class="col-lg-8 col-md-5 col-sm-12">
                        ...
                        <div class="form-group row">
                          <label class="col-form-label col-lg-4 col-md-3 col-sm-12">Operator 8</label>
                          <div class="col-lg-8 col-md-5 col-sm-12">
                        ...
                        <div class="form-group row">
                          <label class="col-form-label col-lg-4 col-md-3 col-sm-12">Cycle Time</label>
                          <div class="col-lg-8 col-md-5 col-sm-12">
                        ...
                        <div class="form-group row">
                          <label class="col-form-label col-lg-4 col-md-3 col-sm-12">Total Target (Est)</label>
                          <div class="col-lg-8 col-md-5 col-sm-12">
