                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-sm table-striped" id="data-table-x">
                                            ...
                                            <tbody>
                                                <?php
                                                if (!empty($data["ng"])) {
                                                    foreach ($data["ng"] as $list) {
                                                        echo "<tr>"
                                                            . "<td class='align-middle'>" . $list["ng_pos_id"] . "</td>"
                                                            . "<td class='align-middle'>" . $list["group_id"] . "</td>"
                                                            . "<td class='align-middle'>" . $list["model_id"] . "</td>"
                                                            . "<td class='align-middle'>" . $list["ng_pos_no"] . "</td>"
                                                            . "<td class='align-middle'>" . $list["desc1"] . "</td>"
                                                            . "<td class='text-center'>"
                                                            . "<a href='?action=$action&id=" . $list["ng_pos_id"] . "' class='btn btn-outline-dark btn-xs text-center mb-1'><i class='material-icons'>edit</i> edit</a>"
                                                            . "</td>"
                                                            . "</tr>";
                                                    }
                                                }
