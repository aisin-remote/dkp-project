                    ...
                    <table class="table table-sm table-striped" id="data-table-x">
                      <thead>
                        <tr>
                          ...
                          <th class="text-nowrap">Jenis Losstime</th>
                          <th class="text-nowrap">Kategori Problem</th>
                          <th class="text-nowrap">Nama Mesin</th>
                          <th class="text-nowrap">Nama Problem</th>
                          <th class="text-nowrap">Start Time</th>
                          <th class="text-nowrap">End Time</th>
                          <th class="text-nowrap">Losstime(m)</th>
                        ...
                        <?php if (!empty($data["list"])) {
                          foreach ($data["list"] as $list) {
                            ...
                            echo "<tr>" . "<td class='text-nowrap'>" . $list["prd_dt"] . "</td>"
                              ...
                              . "<td class='text-nowrap'>" . $list["type2"] . "</td>"
                              . "<td class='text-nowrap'>" . $list["cat_stop"] . "</td>"
                              . "<td class='text-nowrap'>" . $list["mach_id"] . "</td>"
