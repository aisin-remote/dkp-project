                    ...
                    <table class="table table-sm table-striped" id="data-table-x">
                      ...
                      <tbody>
                        <?php if (!empty($data_log)) {
                            $i = 1;
                          foreach ($data_log as $list) {
                            echo "<tr>" . "<td class='text-nowrap'>" . $i . "</td>"
                              . "<td class='text-nowrap'>" . $list["event"] . "</td>"
                              . "<td class='text-nowrap'>" . $list["msg"] . "</td>"
                              . "<td class='text-nowrap'>" . $list["crt_by"] . "</td>"
                              . "<td class='text-nowrap'>" . $list["date"] . "</td>"
                              . "<td class='text-nowrap'>" . $list["time"] ."</td>"
                              . "</tr>";
                            $i++;
                          }
                        }
