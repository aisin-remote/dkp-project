                                            ...
                                            <tbody>
                                                ...
                                                if (!empty($data["ng"])) {
                                                    foreach ($data["ng"] as $list) {
                                                        echo "<tr>"
                                                            . "<td class='align-middle'>" . $list["ng_type_id"] . "</td>"
                                                            . "<td class='align-middle'>" . $list["ng_type_grp"] . "</td>"
                                                            . "<td class='align-middle'>" . $list["name1"] . "</td>"
                                                            . "<td class='text-center'>"
                                                            . "<a href='?action=$action&id=" . $list["ng_type_id"] . "' class='btn btn-outline-dark btn-xs text-center mb-1'><i class='material-icons'>edit</i> edit</a>"
                                                            . "</td>"
                                                            . "</tr>";
                                                    }
                                                }
