        ...
        <div class="container-fluid">
          <ol class="breadcrumb mb-0 mt-2">
            ...
            <li class="breadcrumb-item active"><a
                href="?action=<?php echo $action; ?>&line=<?php echo $data_item_dtl["line_id"]; ?>&date=<?php echo $data_item_dtl["xdate"]; ?>&shift=<?php echo $data_item_dtl["shift"]; ?>">back
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 col-sm-12">
                      <div class="row">
                        ...
                        <div class="col-8">:
                          <?= (!empty($data_item_dtl["op1_name"])) ? $data_item_dtl["op1_name"] : " -" ?>
                        </div>
                        <div class="col-4 text-nowrap">Operator 2</div>
                        <div class="col-8">:
                          <?= (!empty($data_item_dtl["op2_name"])) ? $data_item_dtl["op2_name"] : " -" ?>
                        </div>
                        <div class="col-4 text-nowrap">Operator 3</div>
                        <div class="col-8">:
                          <?= (!empty($data_item_dtl["op3_name"])) ? $data_item_dtl["op3_name"] : " -" ?>
                        </div>
                        <div class="col-4 text-nowrap">Operator 4</div>
                        <div class="col-8">:
                          <?= (!empty($data_item_dtl["op4_name"])) ? $data_item_dtl["op4_name"] : " -" ?>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-3 col-sm-12">
                      <div class="row">
                        ...
                        <div class="col-8">:
                          <?= (!empty($data_item_dtl["op5_name"])) ? $data_item_dtl["op5_name"] : " -" ?>
                        </div>
                        <div class="col-4">Operator 6</div>
                        <div class="col-8">:
                          <?= (!empty($data_item_dtl["op6_name"])) ? $data_item_dtl["op6_name"] : " -" ?>
                        </div>
                        <div class="col-4">Operator 7</div>
                        <div class="col-8">:
                          <?= (!empty($data_item_dtl["op7_name"])) ? $data_item_dtl["op7_name"] : " -" ?>
                        </div>
                        <div class="col-4">Operator 8</div>
                        <div class="col-8">:
                          <?= (!empty($data_item_dtl["op8_name"])) ? $data_item_dtl["op8_name"] : " -" ?>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="col-12 mt-1">
                <div class="card">
                  ...
                  <div class="card-body" style="background-color: #F5F5F5;">
                    ...
                    <div class="row">
                      <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-form-label">Model</div>
                    ...
                    <div class="row mt-1">
                      ...
                      <div class="col-xl-2 col-lg-3 col-md-5 col-sm-6">
                        <input class="form-control form-control-sm" type="number" name="prd_qty" id="prd_qty"
                          value="<?php echo $data_item_dtl["prd_qty"]; ?>" />
                      </div>
                    </div>
                    <div class="row mt-1">
                    ...
                    <div class="row">
                      <div class="col-12 mb-2">
                        <textarea name="detail_text" rows="3"
                          class="form-control"><?php echo $data_item_dtl["detail_text"]; ?></textarea>
                      </div>
                      ...
                      <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12">
                        <input type="number" name="dcqcp" class="form-control"
                          value="<?php echo $data_item_dtl["dcqcp"]; ?>">
                      </div>
                      <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12">
                      ...
                      <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12">
                        <input type="number" name="qaqcp" class="form-control"
                          value="<?php echo $data_item_dtl["qaqcp"]; ?>">
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    if (!empty($data_stop)) {
                      foreach ($data_stop as $row) {
                        ...
                        echo "<tr>"
                          ...
                          . "<td class='text-center'>" . $row["mach_id"] . "</td>"
                          . "<td>" . $row["name1"] . "</td>"
                          . "<td>" . $row["stop_name"] . "</td>"
                ...
                <table class="table table-striped table-sm">
                  <thead>
                    <tr class="table-secondary">
                      <th>No</th>
                      <th>NG Type</th>
                      <th class='text-center'>NG Position</th>
                    ...
                    if (!empty($data_ng)) {
                      foreach ($data_ng as $row) {
                        ...
                        echo "<tr>"
                          . "<td>" . $row["ng_seq"] . "</td>"
                          . "<td>" . $row["ng_type"] . "</td>"
                          . "<td class='text-center'>" . $row["ng_pos_no"] . ". " . $row["desc1"] . "</td>"
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-group row">
                <label for="cat_stop" class="col-sm-3 col-form-label">Kategori Stop</label>
                <div class="col-sm-9">
                  <select id="cat_stop" class="form-control modalSelect01" data-live-search="true">
                    ...
                    if (!empty($list_cat)) {
                      foreach ($list_cat as $row) {
                        if ($row["type1"] == "P") {
                          ...
                          $row["type1"] = "Unplanning";
                        }
                        ?>
                        <option value="<?php echo $row["cat_id"]; ?>"><?php echo $row["type1"] . " - " . $row["name1"]; ?>
                        </option>
                        <?php
                      }
                    }
              ...
              <div class="form-group row">
                <label for="mesin_id" class="col-sm-3 col-form-label">Mesin</label>
                <div class="col-sm-9">
                  <select id="mesin_id" class="form-control modalSelect01" data-live-search="true">
                    <option value="">Select Mesin</option>
                    <?php
                    if (!empty($mach_list)) {
                      foreach ($mach_list as $row) {
                        ?>
                        <option value="<?php echo $row["mach_id"]; ?>"><?php echo $row["name1"]; ?>
                        </option>
                        <?php
                      }
                    }
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="form-group row">
                <label for="loc_x" class="col-sm-3 col-form-label">NG Position</label>
                <div class="col-sm-7">
                  <select id="loc_x" class="form-control modalSelect02" data-live-search="true">
                    <option value="">Select NG Position</option>
                    <?php
        ...
        if (end_time < start_time) {
          ...
          $.ajax({
            ...
            data: {
              ...
              mach_id: $("#mesin_id").val(),
              cat_stop: $("#cat_stop").val()
            },
