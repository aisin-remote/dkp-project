                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-12">
                                            <div class="row">
                                                ...
                                                <div class="col-8">:
                                                    <?= (!empty($data_header["op1_name"])) ? $data_header["op1_name"] : " -" ?>
                                                </div>
                                                <div class="col-4 text-nowrap">Operator 2</div>
                                                <div class="col-8">:
                                                    <?= (!empty($data_header["op2_name"])) ? $data_header["op2_name"] : " -" ?>
                                                </div>
                                                <div class="col-4 text-nowrap">Operator 3</div>
                                                <div class="col-8">:
                                                    <?= (!empty($data_header["op3_name"])) ? $data_header["op3_name"] : " -" ?>
                                                </div>
                                                <div class="col-4 text-nowrap">Operator 4</div>
                                                <div class="col-8">:
                                                    <?= (!empty($data_header["op4_name"])) ? $data_header["op4_name"] : " -" ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3 col-sm-12">
                                            <div class="row">
                                                ...
                                                <div class="col-8">:
                                                    <?= (!empty($data_header["op5_name"])) ? $data_header["op5_name"] : " -" ?>
                                                </div>
                                                <div class="col-4">Operator 6</div>
                                                <div class="col-8">:
                                                    <?= (!empty($data_header["op6_name"])) ? $data_header["op6_name"] : " -" ?>
                                                </div>
                                                <div class="col-4">Operator 7</div>
                                                <div class="col-8">:
                                                    <?= (!empty($data_header["op7_name"])) ? $data_header["op7_name"] : " -" ?>
                                                </div>
                                                <div class="col-4">Operator 8</div>
                                                <div class="col-8">:
                                                    <?= (!empty($data_header["op8_name"])) ? $data_header["op8_name"] : " -" ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-striped table-borderless table-responsive table-sm">
                                            <thead>
                                                ...
                                                <tr style="background-color: #F0F0F0;">
                                                    ...
                                                    <th class="pl-4 text-dark align-middle text-center">POROSITY</th>
                                                    <th class="pl-4 text-dark align-middle text-center">PEELING</th>
                                                    <th class="pl-4 text-dark align-middle text-center">KUROKAWA</th>
                                                    <th class="pl-4 text-dark align-middle text-center">KONTAMINASI</th>
                                                    <th class="pl-4 text-dark align-middle text-center">LEAK O/P</th>
                                                    <th class="pl-4 text-dark align-middle text-center">LEAK W/P</th>
                                                    <th class="pl-4 text-dark align-middle text-center">LEAK GENERAL
                                                    </th>
                                                    <th class="pl-4 text-dark align-middle text-center">CRACK</th>
                                                    <th class="pl-4 text-dark align-middle text-center">BURRYSASI</th>
                                                    <th class="pl-4 text-dark align-middle text-center">TRIAL</th>
                                                    <th class="pl-4 text-dark align-middle text-center">DLL</th>
                                                ...
                                                if (!empty($data2["list"])) {
                                                    foreach ($data2["list"] as $list) {
                                                        echo "<tr>"
                                                            ...
                                                            . "<td class='pl-4 align-middle text-center'>" . $list["ng_rol1"] . "</td>"
                                                            . "<td class='pl-4 align-middle text-center'>" . $list["ng_rol2"] . "</td>"
                                                            . "<td class='pl-4 align-middle text-center'>" . $list["ng_rol3"] . "</td>"
                                                            . "<td class='pl-4 align-middle text-center'>" . $list["ng_rol4"] . "</td>"
                                                            . "<td class='pl-4 align-middle text-center'>" . $list["ng_rol5"] . "</td>"
                                                            . "<td class='pl-4 align-middle text-center'>" . $list["ng_rol6"] . "</td>"
                                                            . "<td class='pl-4 align-middle text-center'>" . $list["ng_rol7"] . "</td>"
                                                            . "<td class='pl-4 align-middle text-center'>" . $list["ng_rol8"] . "</td>"
                                                            . "<td class='pl-4 align-middle text-center'>" . $list["ng_rol9"] . "</td>"
                                                            . "<td class='pl-4 align-middle text-center'>" . $list["ng_rol10"] . "</td>"
                                                            . "<td class='pl-4 align-middle text-center'>" . $list["ng_rol11"] . "</td>"
