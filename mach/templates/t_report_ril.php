                    ...
                    <table class="table table-sm table-striped" id="data-table-x">
                      <thead>
                        <tr>
                          ...
                          <th class="text-nowrap">Qty NG RIL (PCS)</th>
                          <th class="text-nowrap">Dent</th>
                          <th class="text-nowrap">Scratch</th>
                          <th class="text-nowrap">Dansuki</th>
                          <th class="text-nowrap">Work Contact</th>
                          <th class="text-nowrap">Tool Patah</th>
                          <th class="text-nowrap">Deflection NG</th>
                          <th class="text-nowrap">Kontaminasi</th>
                          <th class="text-nowrap">Bibiri</th>
                          <th class="text-nowrap">1/2 Proses</th>
                        ...
                        <?php if (!empty($data["list"])) {
                          foreach ($data["list"] as $list) {
                            echo "<tr>" . "<td class='text-nowrap'>" . $list["prd_dt"] . "</td>"
                              ...
                              . "<td class='text-nowrap text-center'>" . $list["ng_ril"] . "</td>"
                              . "<td class='text-nowrap text-center'>" . $list["ng_ril1"] . "</td>"
                              . "<td class='text-nowrap text-center'>" . $list["ng_ril2"] . "</td>"
                              . "<td class='text-nowrap text-center'>" . $list["ng_ril3"] . "</td>"
                              . "<td class='text-nowrap text-center'>" . $list["ng_ril4"] . "</td>"
                              . "<td class='text-nowrap text-center'>" . $list["ng_ril6"] . "</td>"
                              . "<td class='text-nowrap text-center'>" . $list["ng_ril7"] . "</td>"
                              . "<td class='text-nowrap text-center'>" . $list["ng_ril8"] . "</td>"
                              . "<td class='text-nowrap text-center'>" . $list["ng_ril9"] . "</td>"
                              . "<td class='text-nowrap text-center'>" . $list["ng_ril10"] . "</td>"
                              . "<td class='text-nowrap text-center'>" . $list["ng_ril11"] . "</td>"
