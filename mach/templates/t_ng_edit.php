                ...
                <div class="card mt-2">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      <label class="col-form-label col-lg-2 col-md-3 col-sm-12">ID</label>
                      <div class="col-lg-3 col-md-5 col-sm-12">
                        <input type="text" name="ng_type_id" class="form-control" maxlength="100"
                          value="<?php echo $data["data"]["ng_type_id"]; ?>" <?php if (!empty($data["data"]["ng_type_id"])) {
                               echo "readonly";
                             } ?> required>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-3 col-md-5 col-sm-12">
                        <input type="text" name="ng_type_grp" class="form-control" maxlength="100"
                          value="<?=$data["data"]["ng_type_grp"]?>">
                      </div>
                    </div>
