...
if ($action == "daily_production") {
  ...
  if (isset($_GET["print"])) {
    ...
    $spreadsheet->getActiveSheet()->setCellValue("L11", "Dent");
    $spreadsheet->getActiveSheet()->setCellValue("M11", "Scratch");
    $spreadsheet->getActiveSheet()->setCellValue("N11", "Dantsuki");
    $spreadsheet->getActiveSheet()->setCellValue("O11", "Work Contact");
    $spreadsheet->getActiveSheet()->setCellValue("P11", "Step");
    $spreadsheet->getActiveSheet()->setCellValue("Q11", "Tool Patah");
    $spreadsheet->getActiveSheet()->setCellValue("R11", "Deflection NG")->getStyle("R11")->getAlignment()->setWrapText(true);
    $spreadsheet->getActiveSheet()->setCellValue("S11", "Kontaminasi Coolant")->getStyle("S11")->getAlignment()->setWrapText(true);
    $spreadsheet->getActiveSheet()->setCellValue("T11", "Bibiri");
    $spreadsheet->getActiveSheet()->setCellValue("U11", "1/2 Proses");
    $spreadsheet->getActiveSheet()->setCellValue("V11", "DLL")->getStyle("AC11")->getAlignment()->setWrapText(true);
    ...
    $spreadsheet->getActiveSheet()->setCellValue('J' . ($i + 14), "Porosity");
    $spreadsheet->getActiveSheet()->setCellValue('K' . ($i + 14), "Peeling");
    $spreadsheet->getActiveSheet()->setCellValue('L' . ($i + 14), "Kurokawa");
    $spreadsheet->getActiveSheet()->setCellValue('M' . ($i + 14), "Kontaminasi");
    $spreadsheet->getActiveSheet()->setCellValue('N' . ($i + 14), "Leak O/P");
    $spreadsheet->getActiveSheet()->setCellValue('O' . ($i + 14), "Leak W/P");
    $spreadsheet->getActiveSheet()->setCellValue('P' . ($i + 14), "Leak General");
    $spreadsheet->getActiveSheet()->setCellValue('Q' . ($i + 14), "Crack");
    $spreadsheet->getActiveSheet()->setCellValue('R' . ($i + 14), "Burrysasi");
    $spreadsheet->getActiveSheet()->setCellValue('S' . ($i + 14), "Trial");
    ...
    foreach ($data2["list"] as $key => $value) {
      ...
      $spreadsheet->getActiveSheet()->setCellValue('O' . ($i + 15 + $key), $value["ng_rol6"]);
      ...
      $spreadsheet->getActiveSheet()->setCellValue('T' . ($i + 15 + $key), $value["ng_rol11"]);
