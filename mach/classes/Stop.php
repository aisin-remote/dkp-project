...
class Stop
{
  ...
  public function getById($id)
  {
    ...
    $sql = "SELECT * FROM mach.m_prd_stop_reason_action WHERE srna_id = :id AND app_id = '" . APP . "' ";
  ...
  public function getList($type = null, $type2 = null)
  {
    $return = array();
    $conn = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD);
    $sql = "SELECT a.*, b.pval2 as type1_text, c.pval2 as type2_text FROM mach.m_prd_stop_reason_action a "
      . "LEFT JOIN mach.m_param b ON b.pval1 = a.type1 AND b.pid = 'SRNA_TYPE' "
      . "LEFT JOIN mach.m_param c ON c.pval1 = a.type2 AND c.pid = 'SRNA_TYPE2' ";
    if (!empty($type)) {
  ...
  public function getListType()
  {
    $return = array();
    $conn = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD);
    $sql = "SELECT pval1 as type, pval2 as name1 FROM mach.m_param "
      . "WHERE pid = 'SRNA_TYPE' ";
  ...
  public function insert($param = array())
  {
    ...
    if (empty($param)) {
      ...
      $conn = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD);
      $sql = "INSERT INTO mach.m_prd_stop_reason_action (srna_id, type1, type2, name1, app_id, type3, type4) "
  ...
  public function update($param = array())
  {
    ...
    if (empty($param)) {
      ...
      $conn = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD);
      $sql = "UPDATE mach.m_prd_stop_reason_action SET type1 = :type1, type2 = :type2, type3 = :type3, type4 = :type4, name1 = :name1, app_id = '" . APP . "' "
  ...
  public function getPlannedStopByShift($shift_id)
  {
    $return = array();
    $conn = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD);
    $sql = "SELECT * FROM mach.m_prd_shift_stop WHERE shift_id = '$shift_id' AND app_id = '" . APP . "' ";
  ...
  public function insertMass($param = array()) {
    ...
    $return = array();
    $conn = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD);
    $sql = "INSERT into mach.m_prd_stop_reason_action (srna_id, type1, type2, name1, app_id, type3)
