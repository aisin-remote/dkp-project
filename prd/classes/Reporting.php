...
class Reporting
{
    ...
    public function getList($date_from = "*", $date_to = "*", $prd_year = null, $prd_month = null, $shift = null, $line_id = null, $ldid = null, $jpid = null)
    {
        $return = array();
        $conn = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD);
        $sql = "SELECT a.*, TO_CHAR(a.prd_dt, 'YYYY') as prd_year, TO_CHAR(a.prd_dt, 'MM') as prd_month, "
    ...
    public function getList3($line_id, $prd_dt, $shift)
    {
        $return = array();
        $conn = new PDO(DB_DSN, DB_USERNAME, DB_PASSWORD);
        $sql = "SELECT a.*, b.group_id, b.model_id, b.dies_no, c.loss_time_p, d.loss_time, e.tot_ng, COALESCE(f.ril,0) as ril, 
                       g.rol1, h.rol2, i.rol3, j.rol4, k.rol5, l.rol6, m.rol7, n.rol8, o.rol9, p.rol10
                FROM t_prd_daily_i a 
