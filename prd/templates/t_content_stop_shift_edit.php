                            ...
                            <div class="col-12">
                                <div class="card mt-2">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-lg-2 col-md-3 col-sm-12">Stop Reason Action ID</label>
                                                ...
                                                <select name="srna_id" id="srna_id" class="form-control select2">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $srna["srna_id"]; ?>" <?php if ($srna["srna_id"] == $data["data"]["srna_id"]) {
                                                                                                            echo "selected";
                                                                                                        } ?>><?php echo $srna["srna_id"] . " - " . $srna["name1"]; ?></option>
                                                    <?php
                                                    }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2 col-md-5 col-sm-12">
                                                <select name="time_id" id="time_id" class="form-control select2">
                                                    ...
                                                    ?>
                                                        <option value="<?php echo $time["time_id"]; ?>" <?php if ($time["time_id"] == $data["data"]["time_id"]) {
                                                                                                            echo "selected";
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2 col-md-5 col-sm-12">
                                                <input type="text" name="time_start" class="form-control jam_picker" maxlength="100" value="<?php echo $data["data"]["start_time"]; ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-2 col-md-5 col-sm-12">
                                                <input type="text" name="time_end" class="form-control jam_picker" maxlength="100" value="<?php echo $data["data"]["end_time"]; ?>" required>
                                            </div>
                                        </div>
