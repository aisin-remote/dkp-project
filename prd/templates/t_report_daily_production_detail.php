      ...
      <main>
        <div class="container-fluid">
          <ol class="breadcrumb mb-0 mt-2">
            ...
            <li class="breadcrumb-item active"><a href="?action=<?php echo $action; ?>&id=<?php echo $data_item_dtl["line_id"]; ?>&id2=<?php echo $data_item_dtl["xdate"]; ?>&id3=<?php echo $data_item_dtl["shift"]; ?>&step=2">back
                ...
                <div class="card">
                  ...
                  <div class="card-body" style="background-color: #F5F5F5;">
                    ...
                    <div class="row mt-1">
                      ...
                      <div class="col-xl-2 col-lg-3 col-md-5 col-sm-6">
                        <input class="form-control form-control-sm" type="number" name="prd_qty" id="prd_qty" value="<?php echo $data_item_dtl["prd_qty"]; ?>" disabled />
                      </div>
                    </div>
                    <div class="row mt-1">
                  ...
                  <div class="card-body" style="background-color: #F5F5F5;">
                    <div class="row">
                      <div class="col-12 mb-2">
                        <textarea name="detail_text" rows="3" class="form-control" disabled><?php echo $data_item_dtl["detail_text"]; ?></textarea>
                      </div>
                      <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12">
                        <label class="col-form-label">DC Quality Check Part</label>
                      </div>
                      <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12">
                        <input type="number" name="dcqcp" class="form-control" value="<?php echo $data_item_dtl["dcqcp"]; ?>" disabled>
                      </div>
                      <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12">
                        <label class="col-form-label">QA Quality Check Part</label>
                      </div>
                      <div class="col-xl-2 col-lg-3 col-md-6 col-sm-12">
                        <input type="number" name="qaqcp" class="form-control" value="<?php echo $data_item_dtl["qaqcp"]; ?>" disabled>
                      </div>
                    </div>
                  </div>
                </div>
