                ...
                <div class="col-6">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-4 col-md-5 col-sm-12">
                        <input type="text" name="dies_no" class="form-control" maxlength="100" value="<?php echo $data["data"]["dies_no"]; ?>" <?php if (!empty($data["data"]["dies_no"])) {
                                                                                                                                                  echo "readonly";
                                                                                                                                                } ?> required>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <label class="col-form-label col-lg-4 col-md-3 col-sm-12">CT/Second</label>
                      <div class="col-lg-4 col-md-5 col-sm-12">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-lg-4 col-md-5 col-sm-12">
                        <input type="number" name="stktot" class="form-control" maxlength="100" value="<?php echo $data["data"]["stktot"]; ?>" <?php if ($_GET["id"] != 0) {
                                                                                                                                                  echo "readonly";
                                                                                                                                                } ?>>
                      </div>
                    </div>
