                        ...
                        <div class="col-lg-2 col-md-5 col-sm-12">
                          <select name="type1" class="form-control select2">
                            ...
                            foreach ($type_list as $type) {
                              ?>
                              <option value="<?php echo $type["type"]; ?>" <?php if($type["type"] == $data["data"]["type1"]){echo "selected";} ?>><?php echo $type["name1"]; ?></option>
                              <?php
                            }
                            ?>
                          </select>
                        ...
                        <div class="col-lg-2 col-md-5 col-sm-12">
                          <select name="type2" class="form-control select2">
                            ...
                            foreach ($type2_list as $type) {
                              ?>
                              <option value="<?php echo $type["type"]; ?>" <?php if($type["type"] == $data["data"]["type2"]){echo "selected";} ?>><?php echo $type["name1"]; ?></option>
                              <?php
                            }
                            ?>
                          </select>
