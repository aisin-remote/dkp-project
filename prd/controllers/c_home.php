...
if($action == "home") {
  ...
  $query = "select a.line_id, b.name1 as line_name, a.dies_id, CONCAT(c.group_id,' ',c.model_id) as dies_name, a.cctime, a.pln_qty, a.prd_time, coalesce(a.prd_qty,0) as prd_qty, 
